...
<body class="d-flex flex-column h-100">
    ...
    <footer
        ...
        <span class="smaller-font">&copy; 2021 SeriousEater Group<br /><span class="xsmall-font"><a href="admin/admin_login.php" class="text-decoration-none text-light">Pujitha.</a> Sadana.
                Sapna.</span></span>
